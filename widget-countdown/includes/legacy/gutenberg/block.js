	...
	blocks.registerBlockType('wpdevart-countdown/countdown', {
		...
		edit: function (props) {
			...
			function create_head() {
				return el("div", { className: "head_block", onClick: function (value) { open_close_element(value) } },
					el("span", { className: "title_image" },
						el("img", { src: wpda_countdown_basic_gutenberg['other_data']['content_icon'] })
					),
			...
			function create_content() {
				...
				var aditional_css_countdown_circle_size = {};
				var aditional_css_countdown_circle_border = {};
				var aditional_css_countdown_border_radius = {};
				var aditional_css_countdown_font_size = {};
				...
				if (props.attributes.countdown_type == "button") {
					aditional_css_countdown_circle_size["display"] = "none";
					aditional_css_countdown_circle_border["display"] = "none";
				}
				if (props.attributes.countdown_type == "circle") {
					aditional_css_countdown_border_radius["display"] = "none";
					aditional_css_countdown_font_size["display"] = "none";
				}
				if (props.attributes.countdown_type == "vertical_slide") {
					aditional_css_countdown_circle_size["display"] = "none";
					aditional_css_countdown_circle_border["display"] = "none";
					aditional_css_countdown_border_radius["display"] = "none";
				}
				...
				wpda_countdown_fields.push(wpda_countdown_lb_days_hourse_minutes("countdownday", "countdownhour", "countdownminute", "Countdown expire time", "Type the Countdown expire time.", aditional_css_for_countdownday));
				wpda_countdown_fields.push(wpda_countdown_lb_calendar_input("countdown_experet_date", "Countdown expire date", "Type the Countdown expire date.", aditional_css_countdown_experet_date));
				...
				wpda_countdown_fields.push(wpda_countdown_lb_simple_select("countdownstart_on", { "hide": "Hide countdown", "show_text": "Show text", "redirect": "Redirect" }, "After Countdown expire", "Select the action you prefere after Countdown time expire.", { color: 'red' }));
				...
				// Text color is available in free; the rest are Pro-only lock fields
				wpda_countdown_fields.push(wpda_countdown_lb_color_input("countdown_font_color", "Countdown timer text color", "Choose the Countdown text color.", {}, "wpda_countdown_tr_button wpda_countdown_tr_circle wpda_countdown_tr_slider"));
				var _is_pro = (typeof wpda_countdown_basic_gutenberg !== "undefined" && wpda_countdown_basic_gutenberg.other_data && wpda_countdown_basic_gutenberg.other_data.is_pro) ? 1 : 0;
				if (_is_pro) {
					wpda_countdown_fields.push(wpda_countdown_lb_select_open_hide_params("countdown_type", { "button": "Button", "circle": "Circle", "vertical_slide": "Vertical Slider" }, ["tr_button", "tr_circle", "tr_slider"], "Countdown timer buttons type", "Choose the Countdown buttons type."));
					wpda_countdown_fields.push(wpda_countdown_lb_color_input("countdown_button_color", "Countdown timer background color", "Select the Countdown background color.", {}, "wpda_countdown_tr_button wpda_countdown_tr_circle wpda_countdown_tr_slider"));
					wpda_countdown_fields.push(wpda_countdown_lb_simple_input_with_small("countdown_circle_size", "Countdown timer Size", "Type the Countdown size.", "(px)", aditional_css_countdown_circle_size, "wpda_countdown_tr_circle"));
					wpda_countdown_fields.push(wpda_countdown_lb_simple_input_with_small("countdown_circle_border", "Countdown timer border width", "Type the Countdown border width.", "(0-100)%", aditional_css_countdown_circle_border, "wpda_countdown_tr_circle"));
					wpda_countdown_fields.push(wpda_countdown_lb_simple_input_with_small("countdown_border_radius", "Countdown timer border radius", "Type the Countdown border radius(px).", "(px)", aditional_css_countdown_border_radius, "wpda_countdown_tr_button"));
					wpda_countdown_fields.push(wpda_countdown_lb_simple_input_with_small("countdown_font_size", "Countdown timer font size", "Type the Countdown font-size(px).", "(px)", aditional_css_countdown_font_size, "wpda_countdown_tr_button wpda_countdown_tr_slider"));
					wpda_countdown_fields.push(wpda_countdown_lb_simple_select("countdown_font_famaly", font_familis, "Countdown timer Font Family", "Select the Countdown Font family."));
					wpda_countdown_fields.push(wpda_countdown_lb_simple_select("countdown_animation_type", animation_efects, "Countdown animation type", "Select the Countdown animation type."));
				}
			...
			function wpda_countdown_lb_simple_input(element_name, element_title, element_description, aditional_css = {}, aditional_classes = "") {
				return el('tr', { className: "wpda_simple_input_tr " + "wpda_countdown_" + element_name + " " + aditional_classes, style: aditional_css },
					wpda_countdown_title_and_description(element_title, element_description),
					el('td', { className: "wpda_simple_input_td" },
						el('input', { type: "text", Value: props.attributes[element_name], className: 'wpda_simple_input', onChange: function (value) { var select = value.target; var params = {}; params[element_name] = select.value; props.setAttributes(params) } })
					)

				);

			}
			function wpda_countdown_lb_simple_input_with_small(element_name, element_title, element_description, small_text, aditional_css = {}, aditional_classes = "") {
				return el('tr', { className: "wpda_simple_input_tr " + "wpda_countdown_" + element_name + " " + aditional_classes, style: aditional_css },
					wpda_countdown_title_and_description(element_title, element_description),
					el('td', { className: "wpda_simple_input_td" },
						el('input', { type: "text", Value: props.attributes[element_name], className: 'wpda_simple_input', onChange: function (value) { var select = value.target; var params = {}; params[element_name] = select.value; props.setAttributes(params) } }),
			...
			function wpda_countdown_lb_simple_textarea(element_name, element_title, element_description, aditional_css = {}, aditional_classes = "") {
				return el('tr', { className: "wpda_simple_input_tr " + "wpda_countdown_" + element_name + " " + aditional_classes, style: aditional_css },
					wpda_countdown_title_and_description(element_title, element_description),
					el('td', { className: "wpda_simple_input_td" },
			...
			function wpda_countdown_lb_simple_select(element_name, options_list, element_title, element_description, aditional_css = {}, aditional_classes = "") {
				...
				return el('tr', { className: "wpda_simple_input_tr " + "wpda_countdown_" + element_name + " " + aditional_classes, style: aditional_css },
					wpda_countdown_title_and_description(element_title, element_description),
					el('td', { className: "wpda_simple_input_td" },
						el('select', { className: "wpda_countdown_select", onChange: function (value) { var select = value.target; var params = {}; params[element_name] = select.options[select.selectedIndex].value; props.setAttributes(params) } }, created_options),
					)
				);

			}

			function wpda_countdown_lb_select_open_hide_params(element_name, options_list, open_closed_ids, element_title, element_description, aditional_css = {}, aditional_classes = "") {
				var created_options = new Array();
				...
				return el('tr', { className: "wpda_simple_input_tr " + "wpda_countdown_" + element_name },
					...
					el('td', { className: "wpda_simple_input_td" },
						el('select', {
							className: "wpda_countdown_select", onChange: function (value) {
								...
								for (var i = 0; i < open_closed_ids.length; i++) {
									for (var j = 0; j < curent_element_parent_div.getElementsByClassName("wpda_countdown_" + open_closed_ids[i]).length; j++) {
										curent_element_parent_div.getElementsByClassName("wpda_countdown_" + open_closed_ids[i])[j].style.display = "none";
									}

								}
								for (i = 0; i < curent_element_parent_div.getElementsByClassName("wpda_countdown_" + open_closed_ids[select.selectedIndex]).length; i++) {
									curent_element_parent_div.getElementsByClassName("wpda_countdown_" + open_closed_ids[select.selectedIndex])[i].style.display = "initial";
								}
			...
			function wpda_countdown_lb_days_hourse_minutes(element_day_name, element_hour_name, element_minut_name, element_title, element_description, aditional_css = {}, aditional_classes = "") {
				return el('tr', { className: "wpda_simple_input_tr " + "wpda_countdown_" + element_day_name + " " + aditional_classes, style: aditional_css },
					wpda_countdown_title_and_description(element_title, element_description),
					el('td', { className: "wpda_simple_input_td" },
			...
			function wpda_countdown_lb_calendar_input(element_name, element_title, element_description, aditional_css = {}) {
				var date = "";
			...
			function wpda_countdown_lb_color_input(element_name, element_title, element_description, aditional_css = {}, aditional_classes = "") {
				return el('tr', { className: "wpda_simple_input_tr " + "wpda_countdown_" + element_name + " " + aditional_classes, style: aditional_css },
					wpda_countdown_title_and_description(element_title, element_description),
					el('td', { className: "wpda_color_input_td" },
						el('input', { type: "color", Value: props.attributes[element_name], className: 'wpda_simple_input', onChange: function (value) { var select = value.target; var params = {}; params[element_name] = select.value; props.setAttributes(params) } })
					)
				);

			}

			function wpda_countdown_title_and_description(element_title, element_description) {
		...
		save: function (props) {
			...
			shortcode_atributes = shortcode_atributes + ' countdown_type="' + props.attributes.countdown_type + '"';
			shortcode_atributes = shortcode_atributes + ' font_color="' + props.attributes.countdown_font_color + '"';
			shortcode_atributes = shortcode_atributes + ' button_bg_color="' + props.attributes.countdown_button_color + '"';
			shortcode_atributes = shortcode_atributes + ' circle_size="' + props.attributes.countdown_circle_size + '"';
			shortcode_atributes = shortcode_atributes + ' circle_border="' + props.attributes.countdown_circle_border + '"';
			shortcode_atributes = shortcode_atributes + ' border_radius="' + props.attributes.countdown_border_radius + '"';
			shortcode_atributes = shortcode_atributes + ' font_size="' + props.attributes.countdown_font_size + '"';
			shortcode_atributes = shortcode_atributes + ' countdown_font_famaly="' + props.attributes.countdown_font_famaly + '"';
			shortcode_atributes = shortcode_atributes + ' animation_type="' + props.attributes.countdown_animation_type + '"';
